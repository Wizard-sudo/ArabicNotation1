...
You can try the [annotation](http://doccano.herokuapp.com).

![Demo image](https://w7.pngwing.com/pngs/80/709/png-transparent-android-note-taking-android-blue-text-logo.png)
...
<!-- | GCP[^2] | [![GCP Cloud Run PNG Button](https://w7.pngwing.com/pngs/80/709/png-transparent-android-note-taking-android-blue-text-logo.png)](https://console.cloud.google.com/cloudshell/editor?shellonly=true&cloudshell_image=gcr.io/cloudrun/button&cloudshell_git_repo=https://github.com/doccano/doccano.git&cloudshell_git_branch=CloudRunButton)  | -->
